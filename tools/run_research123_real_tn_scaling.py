...
def main() -> int:
    ...
    report["source"].pop("milestone150_parent_sha", None)
    report["source"]["milestone150_compatibility_basis"] = (
        "exact DATA-25/tokenizer/ModelSpec/packing identities proven at this source SHA"
    )
