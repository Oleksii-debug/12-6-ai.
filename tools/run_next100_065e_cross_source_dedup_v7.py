#!/usr/bin/env python3
"""Run or verify record-granular NEXT100-065E global dedup V7."""
...
from twelve_six.data.cross_source_capacity_audit_v7 import audit_live, verify_report
...
def main() -> int:
    ...
    if args.command == "run":
        base, v4_extension, v5_config, v6_config = v6.load_inputs(
            args.base_inventory,
            args.v4_extension,
            args.v5_config,
            args.v6_config,
        ...
        v6.write_report(report, args.report)
        return 0
