#!/usr/bin/env python3
"""Run or verify NEXT100-065E global cross-source dedup V7."""
...
from twelve_six.data.cross_source_capacity_audit_v7 import (
    audit_live,
    load_inputs,
    verify_report,
    write_report,
...
def main() -> int:
    ...
    run.add_argument("--v7-config", required=True)
    ...
    if args.command == "run":
        base, v4_extension, v5_config, v6_config, v7_config = load_inputs(
            args.base_inventory,
            args.v4_extension,
            args.v5_config,
            args.v6_config,
        ...
        report = audit_live(base, v4_extension, v5_config, v6_config, v7_config)
