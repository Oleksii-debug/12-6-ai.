#!/usr/bin/env python3
"""Run or verify NEXT100-065C global cross-source dedup V5."""
...
from twelve_six.data.cross_source_capacity_audit_v5 import (
    audit_live,
    load_inputs,
    verify_report,
    write_report,
...
def main() -> int:
    ...
    if args.command == "run":
        base, v4_extension, v5_config = load_inputs(
            args.base_inventory,
            args.v4_extension,
            args.v5_config,
        )
        report = audit_live(base, v4_extension, v5_config)
