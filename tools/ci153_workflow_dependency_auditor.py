...
later install step from retroactively validating an earlier tool use.
"""
...
DIRECT_TOOL_RE = re.compile(
    ...
    r"(pytest|ruff|torchrun|vllm|accelerate|deepspeed|transformers-cli|huggingface-cli)\b"
)
