...
class ResearchCorpusV1AcquisitionTests(unittest.TestCase):
    ...
    def test_current_plan_passes_without_promoting_corpus_or_training(self) -> None:
        report = module.validate_plan(copy.deepcopy(self.plan))
        self.assertEqual(report["status"], "PASS_PLANNING_CONTRACT_ONLY")
        self.assertEqual(
            report["remaining_gap_bytes"],
            {"uk": 8_899_144, "en": 6_855_849, "code": 3_930_867, "total": 19_685_860},
        )
        self.assertEqual(
            report["buffered_gross_required_bytes"],
            {"uk": 14_831_907, "en": 11_426_415, "code": 6_551_445, "total": 32_809_767},
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            {"uk": 168_093, "en": 73_585, "code": 148_555, "total": 390_233},
        )
