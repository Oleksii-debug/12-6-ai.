...
The plan binds the current NEXT100-063 source-registry convergence head `9a6b43849042a4c0dc60d6da5e341827ccf311e7` and exact config blob `d5b640b386219290f69d02a7f2e30a338c883009` without modifying that worker's files.
