...
def solve_dense_scaling_candidates(
    ...
    *,
    ...
    architecture template. It accounts for MHA/GQA/MQA query/KV widths, tied or
    untied LM heads, optional attention/MLP/LM-head biases, and optional final norm.
    The caller owns the template search space and any later benchmark decision; this
    function never instantiates model tensors, promotes, or freezes a stage.
    """
