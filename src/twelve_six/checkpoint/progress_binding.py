"""Exact progress binding for fail-closed checkpoint resume.

Integrity hashes prove that checkpoint bytes are internally consistent. They do
not prove that a caller selected the intended positive training step. Callers
that know the intended resume position can bind it here before any model,
optimizer, scheduler, or RNG mutation occurs.
"""
...
def install(core: Any) -> None:
    """Extend checkpoint load APIs with exact progress-counter expectations."""
