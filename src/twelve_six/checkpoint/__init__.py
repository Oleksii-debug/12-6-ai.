...
from .root_snapshot import install as _install_root_snapshot
from .schema_validation import install as _install_manifest_schema
...
_install_manifest_schema(_core)
_install_root_snapshot(_core)
del (
    _core,
    _install_durable_save,
    _install_progress_binding,
    _install_manifest_schema,
    _install_root_snapshot,
    _install_transactional_rng,
)
